...
func (s *UsersService) GetUserByID(uuid uuid.UUID) (model.Users, error) {
	return s.repo.GetUserByID(uuid)
}

func (s *UsersService) UpdateUser(uuid uuid.UUID, fields map[string]interface{}) error {
	return s.repo.UpdateUser(uuid, fields)
}
